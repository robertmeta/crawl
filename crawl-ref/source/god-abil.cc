...
static potion_type _gozag_potion_list[][4] =
{
    ...
    { POT_HASTE, POT_CAMOUFLAGE, NUM_POTIONS, NUM_POTIONS },
    ...
    { POT_INVISIBILITY, POT_CAMOUFLAGE, NUM_POTIONS , NUM_POTIONS },
    { POT_HEAL_WOUNDS, POT_CURING, POT_MAGIC, NUM_POTIONS },
    { POT_HEAL_WOUNDS, POT_CURING, POT_BERSERK_RAGE, NUM_POTIONS },
    { POT_HEAL_WOUNDS, POT_HASTE, POT_CAMOUFLAGE, NUM_POTIONS },
    { POT_MIGHT, POT_BRILLIANCE, NUM_POTIONS, NUM_POTIONS },
    { POT_HASTE, POT_CAMOUFLAGE, POT_FLIGHT, NUM_POTIONS },
    { POT_FLIGHT, POT_CAMOUFLAGE, POT_INVISIBILITY, NUM_POTIONS },
    { POT_RESISTANCE, POT_MIGHT, POT_HASTE, NUM_POTIONS },
    { POT_RESISTANCE, POT_INVISIBILITY, POT_CAMOUFLAGE, NUM_POTIONS },
};
